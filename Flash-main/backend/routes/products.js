...
const {getProducts, getProduct, getProductName, getProductPrice, getProductRating, getProductDescription,
     getProductImage,addProduct} = require('../controllers/ProductsController')
