...
// CONCATENATED MODULE: ./src/api/get-rates.js
var getRates = function getRates(OXR_API_ID, base) {
  var url = 'https://openexchangerates.org/api/latest.json?base=' + base + '&app_id=' + OXR_API_ID;

  return fetch(url, { method: 'GET' }); // eslint-disable-line
};

/* harmony default export */ var get_rates = (getRates);
// EXTERNAL MODULE: ./node_modules/url-join/lib/url-join.js
var url_join = __webpack_require__(3);

// CONCATENATED MODULE: ./src/api/ip-data.js


var ip_data_ipdata = function ipdata(ip, apiKey) {
  var url = url_join('https://api.ipdata.co/', '?api-key=' + apiKey);

  return fetch(url, { method: 'GET' }); // eslint-disable-line
};

/* harmony default export */ var ip_data = (ip_data_ipdata);
// EXTERNAL MODULE: ./node_modules/money/money.js
var money = __webpack_require__(4);

// CONCATENATED MODULE: ./src/utils/conversor.js


var conversor_conversor = function conversor(_ref) {
  var rates = _ref.rates,
      base = _ref.base;

  var fxInstance = money["factory"]();
...
/* harmony default export */ var utils_conversor = (conversor_conversor);
...
var src_LocalCurrency = (_temp2 = _class = function (_React$Component) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              _context.next = 8;
              return get_rates(OXR_API_ID, base).then(checkHttpStatus).then(parseJSON);

            case 8:
              r = _context.sent;
              fxInstance = utils_conversor(r);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return ip_data(null, IPDATA_API_KEY).then(checkHttpStatus).then(parseJSON);
...
}(external_root_React_commonjs2_react_commonjs_react_amd_react_["Component"]), _class.displayName = 'LocalCurrency', _class.propTypes = {
  accept: prop_types_default.a.array,
  amount: prop_types_default.a.number.isRequired,
  base: prop_types_default.a.string.isRequired,
  IPDATA_API_KEY: prop_types_default.a.string.isRequired,
  OXR_API_ID: prop_types_default.a.string.isRequired,
...
/* harmony default export */ var src = __webpack_exports__["default"] = (src_LocalCurrency);
