...
import ProductDetailsAdmin from "../../components/ProductDetailsAdmin/ProductDetailsAdmin"; // Replace with your product component
        ...
        <div className="topbar">
          {products &&
            products
              ...
              .map((product) => (
                <ProductDetailsAdmin key={product._id} product={product} />
              ))}
        </div>
